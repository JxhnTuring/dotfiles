...
Instalamos zsh
```
sudo pacman -S zsh fastfetch grim slurp
```
...
```
sudo cp Wallpaper/background.jpg /usr/share/grub/themes/whitesur
```

### Configurar  fondo de pantalla
Instalamos el wallpapermanager
```
sudo pacman -S awww
```
Corremos:
